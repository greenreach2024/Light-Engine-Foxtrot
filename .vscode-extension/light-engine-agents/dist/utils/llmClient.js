...
class LLMClient {
     ...
     */
    async generateProposal(task, relevantFiles, existingCode) {
     ...
     */
    async generateReview(proposal, mentionedFiles, fileContents) {
     ...
     */
    async generateArchitectureAssessment(proposal, task) {
...
- Misalign with system goals`;
    ...
    // ============= Prompt Builders =============
    buildProposalPrompt(task, relevantFiles, existingCode) {
    ...
    buildReviewPrompt(proposal, mentionedFiles, fileContents) {
    ...
    buildArchitecturePrompt(proposal, task) {
...
LLMClient.DEFAULT_MODEL_SELECTOR = {
    vendor: 'copilot',
    family: 'gpt-4'
};
