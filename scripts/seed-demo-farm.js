...
async function seedDemoFarm() {
  ...
  try {
    ...
    if (CLEAN_FIRST) {
      ...
      console.log('   [OK] Cleaned existing data');
    }
    ...
    console.log(`   [OK] Farm inserted (DB ID: ${dbFarmId})`);
    ...
    console.log(`   [OK] ${farmData.rooms.length} rooms inserted`);
    ...
    console.log(`   [OK] ${zoneCount} zones inserted`);

    // Insert devices (lights and sensors)
    console.log('[IDEA] Inserting devices...');
    let deviceCount = 0;
    ...
    console.log(`   [OK] ${deviceCount} devices inserted`);
    ...
    console.log(`   [OK] ${farmData.inventory.length} trays inserted`);

    // Insert farm metrics
    console.log('[STATS] Inserting farm metrics...');
    await client.query(`
    ...
    console.log('   [OK] Metrics inserted');
    ...
    console.log(`   [OK] Farm data saved to: ${outputPath}`);

    console.log('');
    console.log('[OK] Demo farm seeded successfully!');
    console.log('');
    console.log(' Summary:');
    console.log(`   Farm ID: ${FARM_ID}`);
    ...
    console.log('');
    console.log('[START] You can now query this farm from your application!');
