  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="credentials">
        ...
        <p><strong>Email:</strong> admin@greenreachgreens.com</p>
...
emailTransporter.sendMail({
  ...
  to: 'admin@greenreachgreens.com',
  subject: '🌱 Welcome to GreenReach Farms - Your Account is Ready',
  html: htmlEmail
}).then(() => {
  console.log('✅ Welcome email sent successfully to admin@greenreachgreens.com');
  process.exit(0);
}).catch(err => {
