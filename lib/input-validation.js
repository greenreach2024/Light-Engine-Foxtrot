...
export const validateOrderEvent = [
  ...
  body('event_type')
    ...
    .isIn(['status_change', 'tracking_update', 'note_added', 'issue_reported'])
    .withMessage('event_type must be one of: status_change, tracking_update, note_added, issue_reported'),
  body('status')
    .optional()
    .trim()
