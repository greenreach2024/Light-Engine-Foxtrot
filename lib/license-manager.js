 ...
 * - License file: /etc/lightengine/license.json (or local for dev)
...
const LICENSE_PATH = process.env.LICENSE_PATH || '/etc/lightengine/license.json';
const PUBLIC_KEY_PATH = process.env.PUBLIC_KEY_PATH || './config/greenreach-public.pem';
...
/**
 * Get license tier
 * @returns {Promise<string>} License tier ('inventory-only', 'full', 'enterprise')
 */
