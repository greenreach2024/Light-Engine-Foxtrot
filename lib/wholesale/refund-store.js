...
const refundsDB = Datastore.create({ filename: 'data/wholesale-refunds.db', autoload: true });
...
const brokerFeeReversalsDB = Datastore.create({ filename: 'data/wholesale-broker-fee-reversals.db', autoload: true });
