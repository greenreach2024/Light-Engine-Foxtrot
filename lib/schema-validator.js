...
const groupsSchema = {
  ...
  properties: {
    ...
    groups: {
      ...
      items: {
        type: 'object',
        required: ['id', 'name', 'zone', 'crop', 'trays', 'plants'],
        properties: {
          id: {
            type: 'string',
            minLength: 1,
    ...
    metadata: {
      type: 'object',
      description: 'File metadata (lastUpdated, version, source)',
      properties: {
    ...
    rooms: {
      ...
      items: {
        ...
        properties: {
          ...
          type: {
            type: 'string',
            enum: ['vertical', 'horizontal', 'greenhouse', 'field'],
            description: 'Room type'
          },
          trays: {
            type: 'number',
            minimum: 0,
            description: 'Total tray count in room'
          },
          groups: {
            type: 'number',
            minimum: 0,
            description: 'Number of active groups in room'
          },
          plants: {
            type: 'number',
            minimum: 0,
            description: 'Total plant count in room'
          },
          zones: {
            type: 'array',
          ...
          equipment: {
            type: 'array',
            description: 'Equipment/fixtures in room',
            items: {
              type: 'object',
              properties: {
                name: { type: 'string' },
