...
### Phase 3 — Adaptive Intelligence + Central ML (12 tasks) [COMPLETE]

| # | Task | Owner | Effort | Status |
|---|------|-------|--------|--------|
| 25 | Per-crop recipe modifier (farm-specific + Central) | Farm | L | Done |
| 26 | Tier 2 adaptive control (HVAC learning) | Farm | M | Done |
| 27 | LED aging detection | Farm | M | Done |
| 28 | ML harvest date prediction | Farm | M | Done |
| 29 | Loss prediction from environment trends | Farm | M | Done |
| 30 | Quality trend analysis from AI vision | Farm | S | Done |
| 31 | Cross-farm yield regression ML model | Central | L | Done |
| 32 | Compute & push network recipe modifiers | Central | M | Done |
| 33 | Cross-farm anomaly correlation | Central | M | Done |
| 34 | Loss pattern network alerts | Central | M | Done |
| 35 | Cross-farm energy benchmarks | Central | S | Done |
| 36 | Per-farm performance tracking endpoint | Central | M | Done |

#### Phase 3 Completion Notes

- **Farm-side ML (Tasks 25-30):** Per-crop recipe modifiers with modifier engine (T25). Tier 2 adaptive control with HVAC learning curves (T26). LED aging detection with lumen-depreciation tracking and replacement alerts (T27). ML harvest date prediction using grow-day regression on environment data (T28). Loss prediction from environment trend deviations (T29). Quality trend analysis integrating AI vision scores into yield-quality composite (T30).
