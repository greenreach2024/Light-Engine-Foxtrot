...
router.get('/farms/:farmId', async (req, res) => {
    try {
        ...
        const farm = {
            ...
            address: (locationAddress && (locationAddress.street || locationAddress.address)) || (typeof parsedMeta.address === 'string' ? parsedMeta.address : null) || null,
...
router.get('/farms/:farmId/config', async (req, res) => {
    try {
        ...
        const config = {
            ...
            address: (locObj && (locObj.street || locObj.address)) || (typeof farmMeta.address === 'string' ? farmMeta.address : null) || null,
