...
AI AGENTS
  E.V.I.E. (Farm Assistant):   ONLINE -- 60 tools, outdoor weather + sensor integration
  F.A.Y.E. (Admin Operations): ONLINE -- 123 tools, Cloud Run logs + billing access
  G.W.E.N. (Research Agent):   ONLINE -- 127 tools, live OSF API + PDF export
...
INFRASTRUCTURE
  ...
  Region: us-east1
  Central Revision: greenreach-central-00145-mm2
...
<tr><td style="padding:32px 40px;">
  ...
  <table width="100%" cellpadding="8" cellspacing="0" style="font-size:14px;border-collapse:collapse;margin:0 0 24px;">
    <tr style="border-bottom:1px solid #e2e8f0;"><td style="color:#4a5568;">E.V.I.E. (Farm Assistant) -- 60 tools</td><td style="color:#16a34a;font-weight:600;text-align:right;">ONLINE</td></tr>
    <tr style="border-bottom:1px solid #e2e8f0;"><td style="color:#4a5568;">F.A.Y.E. (Admin Operations) -- 123 tools</td><td style="color:#16a34a;font-weight:600;text-align:right;">ONLINE</td></tr>
    <tr><td style="color:#4a5568;">G.W.E.N. (Research Agent) -- 127 tools</td><td style="color:#16a34a;font-weight:600;text-align:right;">ONLINE</td></tr>
  </table>
  ...
  <p style="color:#64748b;font-size:12px;margin:16px 0 0;text-align:center;">Central Revision: greenreach-central-00145-mm2 | GCP: us-east1</p>
</td></tr>
