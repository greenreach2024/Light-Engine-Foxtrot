...
function renderMappingReview() {
  ...
  reviewEl.innerHTML = `
    <div style="background: var(--gr-surface); padding: 16px; border-radius: 8px;">
      ${isUpdate ? '<div style="background: var(--gr-accent); color: white; padding: 6px 12px; border-radius: 4px; margin-bottom: 12px; font-size: 12px; font-weight: 600;">✏️ UPDATING EXISTING MAPPING</div>' : ''}
