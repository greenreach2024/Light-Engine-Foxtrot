...
function renderGroupsV2PlanCard(plan, dayNumber) {
  ...
  <canvas id="groupsV2PlanSpectrumCanvas" class="group-info-card__canvas" width="280" height="100" role="img" aria-label="Plan spectrum preview" style="width: 100%;"></canvas>
      <div style="background: rgba(15, 23, 42, 0.78); border: 1px solid rgba(148, 163, 184, 0.22); border-radius: 6px; padding: 10px; min-height: 85px;">
        <div class="tiny" style="font-weight: 600; margin-bottom: 6px; color: #cbd5e1;">Channel Mix</div>
      ...
      <div id="groupsV2PlanColorBreakdown" style="background: rgba(14, 116, 144, 0.16); border: 1px solid rgba(56, 189, 248, 0.28); border-radius: 6px; padding: 10px; min-height: 95px; display: none;">
