...
async function testWizardSystem() {
  ...
  try {
    ...
    console.log('[TARGET] Test 2: Getting MQTT wizard definition...');
    ...
    console.log('[FAST] Test 3: Executing first step of MQTT wizard...');
    const stepData = {
      host: '192.168.2.38',
      port: 8883,
      secure: true,
    ...
    console.log('[STATS] Test 4: Checking wizard execution status...');
    ...
    console.log('[IDEA] Test 5: Testing wizard suggestions...');
    const testDevices = [
      {
        ip: '192.168.2.38',
    ...
    console.log('[OK] All wizard system tests completed successfully!');
