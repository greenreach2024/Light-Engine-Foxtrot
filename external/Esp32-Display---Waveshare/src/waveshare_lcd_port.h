...
#define IO_EXPANDER_CH422G_ADDRESS (0x20)
...
#define EXAMPLE_LCD_COLOR_BITS                  (16)  // Color depth in bits (RGB565 on ESP32-S3)
...
#define EXAMPLE_LCD_RGB_TIMING_HSYNC_IDLE_LOW    (0)
#define EXAMPLE_LCD_RGB_TIMING_VSYNC_IDLE_LOW    (0)
...
#define EXAMPLE_LCD_PIN_TEST_HOLD_TIME_MS       (3500)
#define EXAMPLE_LCD_PIN_TEST_STOP_ON_SUCCESS    (1)
